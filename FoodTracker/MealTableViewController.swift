...
class MealTableViewController: UITableViewController {
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "Add Item":
            os_log("Adding a newmeal.", log: OSLog.default, type: .debug)
        case "ShowDetail":
    ...
    private func loadSampleMeals() {
        ...
        guard let meal2 = Meal(name: "Cheken and Potatoes", photo: photo2, rating: 5) else{
